...
(function($, window, document, undefined) {
	...
	//	console.log(settings.length);
		var $msb_main = "<a class='msb_main'><i class='font-icon icon-iconfont-share'></i></a>";
	...
	function replaceAPI(api, options) {
		...
		api = api.replace('{content}', options.content.substr(0,options.length));
	...
	function autocenter() {
		...
		var elW = $("#weixina").width();
		var elH = $("#weixina").height();
		console.log((bodyW - elW) / 2);
		$("#weixina").css("left", (bodyW - elW) / 2);
		$("#weixina").css("top", (bodyH - elH) / 2);
	}

	function showWX(url) {
		var weixing = '<div id="weixina">' +
